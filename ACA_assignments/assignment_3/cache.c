	     ...
	     md_addr_t *repl_addr)	/* for address of replaced block */
{
  ...
  unsigned int temp,fasthit_temp,flag=0,fasthit_flag=0;
  ...
  case NRU:
  {
           ...
           for( blk_copy =cp->sets[set].way_head ; blk_copy <= cp->sets[set].way_tail; blk_copy=blk->way_next )
           {
